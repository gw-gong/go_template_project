...
import (
	...
	"github.com/gw-gong/go-template-project/api/http/svc01/api"
	"github.com/gw-gong/go-template-project/api/http/svc01/app"
	"github.com/gw-gong/go-template-project/api/http/svc01/portal"
	"github.com/gw-gong/go-template-project/api/http/svc01/private"
