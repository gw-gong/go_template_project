...
func (r *PortalRouter) Bind(router *gin.Engine) {
	...
	{
		group01.POST("/test", handlertest.NewTest01PortalHandler(r.Biz01))
	}

	group02 := portalGroup.Group("/group02")
	{
		group02.POST("/testx", handlertest.NewTest02PortalHandler(r.Biz02, r.Test01DbManager, r.Test02DbManager))
	}
}
