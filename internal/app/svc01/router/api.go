...
func (r *ApiRouter) Bind(router *gin.Engine) {
	...
	{
		group01.POST("/test", handlertest.NewTest01ApiHandler(r.Biz01))
	}

	group02 := apiGroup.Group("/group02")
	{
		group02.POST("/test", handlertest.NewTest02ApiHandler(r.Biz02, r.Test01DbManager, r.Test02DbManager))
	}
}
